...
void loop()
{
  ...
  else
  {
      ...
      // b3 is used for horiz scrolling in scroll mode
      if (!scroll_mode)
      {
  ...
  // scroll mode combo
  if (!digitalRead(Button0) && !digitalRead(Button3))
  {
    scroll_mode = !scroll_mode;
    while(!digitalRead(Button0) || !digitalRead(Button3))
      delay(50);
    rep.x_axis = 127;
    rep.y_axis = 127;
    rep.b0 = 0;
...
#ifdef DEBUG
    // Very verbose debug
    Serial.print(gp_serial);
    Serial.print(" ");
    Serial.print(drvpos);
    Serial.print(" ");
    Serial.print(mouse_emu);
    Serial.print(" ");
    Serial.print(paddle_emu);
    Serial.print(" ");
    Serial.print(rep.spinner);
    Serial.print(" ");
    Serial.print(rep.paddle);
    Serial.print(" ");
    Serial.print(rep.b0);
    Serial.print(" ");
    Serial.print(rep.b1);
